...
## Workflow
1. **Spec-Driven Development:** Do not write code without an agreed-upon specification in `docs/project/spec.md` and an implementation plan in `docs/IMPLEMENTATION_PLAN.md`.
