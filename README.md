...
**`[>]` Multi-Manager Wrapper** — Install, search, and remove packages across DNF, APT, Brew, Flatpak, Snap, Zypper, Pacman, Paru, and MacPorts &mdash; plus `pipx`, `uv`, and `go` language-specific package managers &mdash; through a single CLI.
